...
class VerifLichenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('verified_herba/lichenherba/index', ['speciment_herbarium' => $speciment_herbarium]);
    }
    ...
    public function verified()
    {
       ...
       ->join('species', 'speciment_herbarium.species_id', '=', 'species.id_species')
        ...
        ->paginate(5);
        return view('verified_herba/lichenherba/verified', ['speciment_herbarium' => $speciment_herbarium]);
    }
    ...
    public function view($id_herba)
    {
        ...
        if ($speciment_herba == null || count($speciment_herba) == 0) {
            return redirect()->intended('verified_herba/lichenherba/index');
        }

        return view('verified_herba/lichenherba/view',['speciment_herba' => $speciment_herba]);
    }
    ...
    public function verif($id_herba)
    {
        ...
        return redirect()->action('VerifLichenController@index');
    }
