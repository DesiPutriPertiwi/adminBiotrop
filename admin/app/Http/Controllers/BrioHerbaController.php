...
class BrioHerbaController extends Controller
{
    protected function index()
    {
        ...
        return view('herbarium/brioherba/index', ['speciment_herbarium'=> $speciment_herbarium]);
    }

    protected function create()
    {
        return view('herbarium/brioherba/createAuthor');
    }
    ...
    public function createnext(Request $request)
     {
        ...
        return view('/herbarium/brioherba/createSpecimen', ['data'=>$data]);
     }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()-> intended('/herbarium-management/briovitasherba');
    }
     ...
     protected function show($id_herba)
    {
        ...
        return view('herbarium/brioherba/show', ['speciment_herbarium' => $speciment_herba]);
    }
    ...
    public function destroy($id_herba)
    {
        ...
        if ($speciment_herba == null || count($speciment_herba) == 0) {
            return redirect()->intended('/herbarium-management/brioherba');
        }
         $speciment_herba  ->delete();
        
         return redirect()->intended('/herbarium-management/briovitasherba')->with(['message'=> 'Successfully deleted!!']);
    }
    ...
    protected function edit($id_herba)
    {
        ...
        return view('herbarium/brioherba/edit', ['speciment_herbarium' => $speciment_herbarium, 'state' => $state]);
    }
    ...
    public function update(Request $request, $id_herba)
    {
        ...
        $location -> save();
        $data =['collect'=>$collect->id_collector, 'author'=>$author->id_author, 'location'=>$location->id_location];
        return view('/herbarium/brioherba/edits',['speciment_herbarium' => $speciment_herba, 'data'=>$data]);
    }
    ...
    public function destination(Request $request){
        ...
        return view('herbarium.brioherba.createAuthor', ['state' => $state]);
       // dd($request);
    }
