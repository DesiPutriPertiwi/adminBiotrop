...
class VerifForestController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select(
            ...
            'verified.status')
        ->paginate(5);
        return view('verified_herba/forestherba/index', ['speciment_herbarium' => $speciment_herbarium]);
    }
    ...
    public function verified()
    {
       $speciment_herbarium = DB::table('speciment_herbarium')
        ...
        ->paginate(5);
        return view('verified_herba/forestherba/verified', ['speciment_herbarium' => $speciment_herbarium]);
    }
    ...
    public function view($id_herba)
    {
        ...
        if ($speciment_herba == null || count($speciment_herba) == 0) {
            return redirect()->intended('verified_herba/forestherba/index');
        }

        return view('verified_herba/forestherba/view',['speciment_herba' => $speciment_herba]);
    }
    ...
    public function verif($id_herba)
    {
        ...
        $verif    ->save();
        // dd($verif);
        return redirect()->action('VerifForestController@index');
    }
