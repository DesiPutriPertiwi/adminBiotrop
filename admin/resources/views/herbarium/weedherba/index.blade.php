        ...
        <div class="box">
            <div class="box-header">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-rigth">
                        <a class="btn btn-primary" href="{{route('weedherba.create')}}">Add new Collection</a>
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <form method="POST" action="{{ route('weedherba.search') }}">
                        {{ csrf_field() }}
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                <thead>
                                    <tr role="row" >
                                        ...
                                        <th width="20%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Description: activate to sort column ascending" style="text-aligh: center">Description</th>
