                                ...
                                <div class="col-md-17 col-md-offset-1">
                                    <div class="row bs-wizard" style="border-bottom" name="label">
                                        ...
                                        <div class="col-xs-6 bs-wizard-step complete">
                                            ...
                                            <a href="{{route('weedherba.create')}}" class="bs-wizard-dot"></a>
                                        </div>
                                    ...
                                    <div class="box">
                                        <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('weedherba.store') }}" style="margin-top:10px">
                                        {{ csrf_field() }}
