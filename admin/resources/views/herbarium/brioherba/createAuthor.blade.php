                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-17 col-md-offset-1">
                                    ...
                                    <div class="box">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ route('brioherba.createnext') }}" style="margin-top:10px">
                                        {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-md-offset-8 text-right" >
                                                    <button type="button" class="col-md-2 btn btn-secondary" onclick="window.location='{{ url("herbarium-management/briovitasherba") }}'" >Cancel</button>
