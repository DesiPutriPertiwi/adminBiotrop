                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-17">
                                    ...
                                    <div class="box">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ route('forestherba.update', ['$id_herba' => $speciment_herbarium->id_herbarium]) }}" style="margin-top:10px">
                                            ...
                                            <label style="text-align= right margin-button:5px">
                                                ...
                                                <div class="form-group{{ $errors->has('name_author') ? ' has-error' : '' }}" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="name_author" type="text" class="form-control" placeholder="Determine Name" name="name_author" value="{{ $speciment_herbarium->determine->name_author }}" require autofocus>
                                                ...
                                                <div class="form-group{{ $errors->has('email_author') ? ' has-error' : '' }}" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="email_author" type="email" class="form-control"   placeholder="Email" name="email_author" value="{{  $speciment_herbarium->determine->email_author }}"autofocus>
                                                ...
                                                <div class="form-group{{ $errors->has('date_ident') ? ' has-error' : '' }}" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="date_ident" type="date" class="date_ident" name="date_ident" value="{{  $speciment_herbarium->determine->date_ident }}" required autofocus>
                                                ...
                                                <div class="form-group{{ $errors->has('agency') ? ' has-error' : '' }}" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <textarea id="agency" type="date" class="agency" name="agency" >{!!$speciment_herbarium->determine->agency!!}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-md-offset-8 text-right" >
                                                    <button type="button" class="col-md-2 btn btn-secondary" onclick="window.location='{{ url("herbarium-management/forestherba") }}'" >Cancel</button>
            ...
            $(document).ready(function(){
                ...
                $(document).on('change','.states',function(){
                    ...
                    var op=" ";
                     ...
                     $.ajax({
                        type:'get',
                        url:'{!!URL::to('herbarium-management/forestherba/create/findProv')!!}',
                        dataType:'json',
                        data:{'id':states_id},
                ...
                $(document).on('change','.province',function(){
                    ...
                    var op=" ";
                     ...
                     $.ajax({
                        type:'get',
                        url:'{!!URL::to('herbarium-management/forestherba/create/findCity')!!}',
                        dataType:'json',
                ...
                $(document).on('change','.city',function(){
                    ...
                    var op=" ";
                     ...
                     $.ajax({
                        type:'get',
                        url:'{!!URL::to('herbarium-management/forestherba/create/findDists')!!}',
                        dataType:'json',
