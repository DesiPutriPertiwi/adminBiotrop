                                ...
                                <div class="col-md-17 col-md-offset-1">
                                    <div class="row bs-wizard" style="border-bottom" name="label">
                                        ...
                                        <div class="col-xs-6 bs-wizard-step complete">
                                            ...
                                            <a href="{{route('forestherba.edit',['$id_herba' => $speciment_herbarium->id_herbarium])}}" class="bs-wizard-dot"></a>
                                        </div>
                                    ...
                                    <div class="box">
                                        <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('forestherba.updatestep',['$id_herba' => $speciment_herbarium->id_herbarium]) }}" style="margin-top:10px">
                                            ...
                                            <div class="form-group" >
                                                <div class="col-md-12 col-md-offset-8 text-right">
                                                    <button type="button" class="col-md-2 btn btn-secondary" onclick="window.location='{{ route('forestherba.edit',['$id_herba' => $speciment_herbarium->id_herbarium])}}'" >Previous</button>
