                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-17 col-md-offset-1">
                                    ...
                                    <div class="box">
                                        <form class="form-horizontal" role="form" method="POST" action="{{ route('weedherba.store') }}" style="margin-top:10px">
                                        {{ csrf_field() }}
                                            <div class="form-group{{ $errors->has('label_weed') ? ' has-error' : '' }}" >
                                                ...
                                                <div class="col-md-2">
                                                    <input id="label_weed" type="number" placeholder="Amount" class="form-control" name="label_weed" value="{{ old('label_weed') }}">
                                            ...
                                            <div class="form-group" >
                                                <div class="col-md-12 col-md-offset-8 text-right" style="margin-top:100px"> 
                                                    <a type="submit" class="btn btn-primary col-md-2" href="{{route('forestherba.create')}}">Previous</a>
                                                    <a type="submit" class="btn btn-primary col-md-2" href="{{route('forestrba.store')}}"  style="margin-left:10px">Submit</a>
                                                </div>
                                            </div>
                                        </form>
