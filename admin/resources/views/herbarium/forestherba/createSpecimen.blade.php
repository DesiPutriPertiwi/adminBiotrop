                                ...
                                <div class="col-md-17 col-md-offset-1">
                                    <div class="row bs-wizard" style="border-bottom" name="label">
                                        ...
                                        <div class="col-xs-6 bs-wizard-step complete">
                                            ...
                                            <a href="{{route('forestherba.create')}}" class="bs-wizard-dot"></a>
                                        </div>
                                    ...
                                    <div class="box">
                                        <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('forestherba.store') }}" style="margin-top:10px">
                                        {{ csrf_field() }}
                                            ...
                                            <div class="form-group{{ $errors->has('num_dupt') ? ' has-error' : '' }}" >
                                                ...
                                                <div class="col-md-2">
                                                    <input id="num_dupt" type="number" placeholder="Amount" class="form-control" name="num_dupt" value="{{ old('num_dupt') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('dupt_form') ? ' has-error' : '' }}" >
                                                ...
                                                <div class="col-md-4">
                                                    <input id="dupt_form" type="text" placeholder="Duplicate From" class="form-control" name="dupt_form" value="{{ old('dupt_form') }}">
                                                ...
                                                <div class=" col-md-2" placeholder="amount">
                                                    <input id="num_form" type="number" placeholder="Amount" class="form-control" name="num_form" value="{{ old('num_form') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group{{ $errors->has('dupt_send') ? ' has-error' : '' }}" >
                                                ...
                                                <div class="col-md-4">
                                                    <input id="dupt_send" type="text" placeholder="Duplicate Send To" class="form-control" name="dupt_send" value="{{ old('dupt_send') }}">
                                                ...
                                                <div class=" col-md-2" placeholder="amount">
                                                    <input id="num_send" type="number" placeholder="Amount" class="form-control" name="num_send" value="{{ old('num_send') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group{{ $errors->has('species') ? ' has-error' : '' }}">
                                                <label for="species" class="col-md-2 col-md-offset-1" style="text-align:left">Species</label>
                                                 <div class="col-md-6">
                                                    <i>                                                   
                                                        <input id="species" type="text" placeholder="Species name" class="form-control" name="species" value="{{ old('species') }}" require>
                                                    </i>
                                            ...
                                            <div class="form-group{{ $errors->has('subspecies') ? ' has-error' : '' }}"  >
                                                ...
                                                <div class="col-md-6">
                                                    <input id="subspecies" type="text" placeholder="Subspecies name" class="form-control" name="subspecies" value="{{ old('subspecies') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('variety') ? ' has-error' : '' }}"  >
                                                ...
                                                <div class="col-md-6">
                                                    <input id="variety" type="text" placeholder="Forma name" class="form-control" name="variety" value="{{ old('variety') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('venacular_name') ? ' has-error' : '' }}"  >
                                                ...
                                                <div class="col-md-6">
                                                    <input id="venacular_name" type="text" placeholder="Venacular Name" class="form-control" name="venacular_name" value="{{ old('venacular_name') }}">
                                            ...
                                            <div class="form-group{{ $errors->has('notes') ? ' has-error' : '' }}"  >
                                                ...
                                                <div class="col-md-7">
                                                    <textarea id="notes" row="7" cols="5" oneKeyPress placeholder="Another Characterictic" class="form-control" name="notes" value="{{ old('notes') }}"></textarea>
                                                    @if ($errors->has('notes'))
                                                        <span class="help-block">
                                            ...
                                            <div class="form-group" >
                                                <div class="col-md-12 col-md-offset-8 text-right">
                                                    <button type="button" class="col-md-2 btn btn-secondary" onclick="window.location='{{ url("herbarium-management/forestherba/create") }}'" >Previous</button>
