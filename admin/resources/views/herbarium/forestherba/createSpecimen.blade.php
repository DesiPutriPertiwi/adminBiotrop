                                        ...
                                        {{ csrf_field() }}
                                            ...
                                            <div class="form-group" >
                                                <div class="col-md-6 col-md-offset-6 text-right" style="margin-top:100px"> 
                                                    <a type="submit" class="btn btn-primary" href="{{route('forestherba.create')}}">Previous</a>
                                                    <a type="submit" class="btn btn-primary" href="{{route('forestherba.store')}}"  style="margin-left:10px">Submit</a>
                                                </div>
                                            </div>
                                        </form>
